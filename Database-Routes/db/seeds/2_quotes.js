  ...
  return knex('Quotes').del()
    .then(function () {
      ...
      return knex('Quotes').insert([
        ...
        {quote: "All relationships have one law. Never make the one you love feel alone, especially when you're there.", img: "https://img.huffingtonpost.com/asset/5745f7271200002e008947fb.jpeg?ops=scalefit_970_noupscale", writer: "unknown", heart: false, category_id: 2},
        ...
        {quote: "No relationship is all sunshine. But two people can share one umbrella and survive the storm together.", img: "https://i.pinimg.com/564x/19/c5/e2/19c5e2ec749e44e1740efffc609b982d.jpg", writer: "extramadness", heart: false, category_id: 3},
        ...
        {quote: "Stop doubting yourself, work hard, and make it happen.", img: "https://media.mnn.com/assets/images/2015/11/cat%20with%20lion%20shadow.jpg.696x0_q80_crop-smart.jpg", writer: "unknown", heart: false, category_id: 4},
        ...
        {quote: "When we have each other, we have everything.", img: "http://2.bp.blogspot.com/-aabd1qmBObU/VKLBdQ2T42I/AAAAAAAABpc/b2nH1VXU-b8/s1600/2014-19-10%2Bgroup%2Bhug.jpg", writer: "unknown", heart: false, category_id: 5},
